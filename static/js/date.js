    ...
    var calendarSwitch = (function() {
        ...
        calendarSwitch.prototype = { /*说明：初始化插件*/
            ...
            init: function() {
                ...
                me.startid = me.settings.startid;
                me.endid = me.settings.endid;
                me.dayid = me.settings.dayid;
                        ...
                        if ($(this).text() == '离店') {
                            ...
                            $(me.sections).find('.tbody .rz').each(function(index, element) {
                                if ($(this).text() == '入住') {
                                    ...
                                    //添加入住到input
                                    $('#' + me.startid).val(startDayYear + '-' + startDayMonth + '-' + day);
                                }
                                if ($(this).text() == '离店') {
                                    ...
                                    //添加入住到input
                                    $('#' + me.endid).val(endDayYear + '-' + endDayMonth + '-' + day);
                                   // console.log($("#startDate").val().replace(/[^0-9]/ig, ""))
                                   // console.log($("#endDate").val().replace(/[^0-9]/ig, ""))
                                   // 如果入住等于离店
                                    if (parseInt($("#" + me.startid).val().replace(/[^0-9]/ig, "")) == parseInt($("#" + me.endid).val().replace(/[^0-9]/ig, ""))) {
                                        var x = $('#' + me.startid).val();
                            ...
                            $('#' + me.dayid).val(NumDate);

                            var st = $('#' + me.startid).val();
                            var en = $('#' + me.endid).val();
                            //如果入住没值
                            if (st) {
                                me._slider(me.sections)
            ...
            _selectDate: function(arry1) {
                ...
                $(arry1).on('click', function(index) {
                    ...
                    if (flag == 0) {
                        ...
                        var st = new Date($('#' + me.startid).val());
                        var en = new Date($('#' + me.endid).val());
