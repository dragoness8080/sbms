...
class Core extends WeModuleSite
{
    ...
    public function getMainMenu()
    {
        ...
        $cur_color = ' style="color:#d9534f;" '; 
          if ($_W['role'] == 'operator') {
            $navemenu[8] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=hotel&m=sbms" class="panel-title wytitle" id="yframe-8"><icon style="color:#8d8d8d;" class="fa fa-cart-plus"></icon>  酒店管理</a>',
                'items' => array(
        ...
        $navemenu[14] = array(
            ...
            'title' => '<a href="index.php?c=site&a=entry&op=display&do=ptdata&m=sbms" class="panel-title wytitle" id="yframe-14"><icon style="color:#8d8d8d;" class="fa fa-newspaper-o"></icon>  数据概况</a>',
            'items' => array(
        ...
        $navemenu[17] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=nav&m=sbms" class="panel-title wytitle" id="yframe-17"><icon style="color:#8d8d8d;" class="fa fa-compass"></icon>导航管理</a>',
                'items' => array(
          ...
          $navemenu[2] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=ad&m=sbms" class="panel-title wytitle" id="yframe-2"><icon style="color:#8d8d8d;" class="fa fa-gift"></icon>广告管理</a>',
                'items' => array(
         ...
         $navemenu[18] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=order&m=sbms" class="panel-title wytitle" id="yframe-18"><icon style="color:#8d8d8d;" class="fa fa-server"></icon>订单管理</a>',
                'items' => array(
       ...
       $navemenu[6] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=coupon&m=sbms" class="panel-title wytitle" id="yframe-6"><icon style="color:#8d8d8d;" class="fa fa-bars"></icon>优惠券管理</a>',
                'items' => array(
                ...
                $navemenu[20] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=jftype&m=sbms" class="panel-title wytitle" id="yframe-20"><icon style="color:#8d8d8d;" class="fa fa-star-half-o"></icon>  积分商城</a>',
                'items' => array(
     ...
     if($type['open_member']==1){                      
       $navemenu[1] = array(
            'title' => '<a href="index.php?c=site&a=entry&op=display&do=memberlevel&m=sbms" class="panel-title wytitle" id="yframe-1"><icon style="color:#8d8d8d;" class="fa fa-money"></icon>  会员等级</a>',
            'items' => array(
         ...
         $navemenu[9] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=fxlist&m=sbms" class="panel-title wytitle" id="yframe-9"><icon style="color:#8d8d8d;" class="fa fa-users"></icon>  分销系统</a>',
                'items' => array(
          ...
          /* $navemenu[10] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=sponsor&m=sbms" class="panel-title wytitle" id="yframe-10"><icon style="color:#8d8d8d;" class="fa fa-users"></icon> 主办方管理</a>',
                'items' => array(
          ...
          $navemenu[3] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=txlist&m=sbms" class="panel-title wytitle" id="yframe-3"><icon style="color:#8d8d8d;" class="fa fa-money"></icon>  提现管理</a>',
                'items' => array(
            ...
            $navemenu[4] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=user2&m=sbms" class="panel-title wytitle" id="yframe-4"><icon style="color:#8d8d8d;" class="fa fa-user"></icon>  用户管理</a>',
                'items' => array(
      ...
      public function getMainMenu2()
    {
        ...
        $cur_color = ' style="color:#d9534f;" '; 
        $navemenu[14] = array(
            'title' => '<a href="index.php?c=site&a=entry&op=display&do=statistics&m=sbms" class="panel-title wytitle" id="yframe-14"><icon style="color:#8d8d8d;" class="fa fa-newspaper-o"></icon>  门店信息</a>',
            'items' => array(
        ...
        $navemenu[8] = array(
            'title' => '<a href="index.php?c=site&a=entry&op=display&do=room&m=sbms" class="panel-title wytitle" id="yframe-8"><icon style="color:#8d8d8d;" class="fa fa-cart-plus"></icon>房型管理</a>',
            'items' => array(
         ...
         $navemenu[12] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=inorder&m=sbms" class="panel-title wytitle" id="yframe-12"><icon style="color:#8d8d8d;" class="fa fa-cog"></icon> 订单管理</a>',
                'items' => array(
        ...
        $navemenu[17] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=number&m=sbms" class="panel-title wytitle" id="yframe-17"><icon style="color:#8d8d8d;" class="fa fa-compass"></icon>酒店维护</a>',
                'items' => array(
         ...
         $navemenu[18] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=incoupon&m=sbms" class="panel-title wytitle" id="yframe-18"><icon style="color:#8d8d8d;" class="fa fa-bars"></icon>优惠券管理</a>',
                'items' => array(
         ...
         $navemenu[10] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=assess&m=sbms" class="panel-title wytitle" id="yframe-10"><icon style="color:#8d8d8d;" class="fa fa-user"></icon> 评论管理</a>',
                'items' => array(
       ...
       $navemenu[6] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=txdetails&m=sbms" class="panel-title wytitle" id="yframe-6"><icon style="color:#8d8d8d;" class="fa fa-bars"></icon>提现管理</a>',
                'items' => array(
            ...
            $navemenu[4] = array(
                'title' => '<a href="index.php?c=site&a=entry&op=display&do=print&m=sbms" class="panel-title wytitle" id="yframe-4"><icon style="color:#8d8d8d;" class="fa fa-cog"></icon>  消息设置</a>',
                'items' => array(
    ...
    {
        global $_W, $_GPC;
        $account=pdo_get('sbms_account',array('storeid'=>$storeid,'uid'=>$uid));
        $do = $_GPC['do'];
        $navemenu = array();
        $cur_color = '#8d8d8d';
          if($account['role']==1){
        $navemenu[0] = array(
             'title' => '<a href="zhjd.php?c=site&a=entry&op=display&do=dlstatistics&m=sbms" class="panel-title wytitle" id="yframe-0"><icon style="color:#8d8d8d;" class="fa fa-newspaper-o"></icon>  门店信息</a>',
            'items' => array(
        ...
        $cur_color = '#8d8d8d';
        $navemenu[1] = array(
            'title' => '<a href="zhjd.php?c=site&a=entry&op=display&do=dlroom&m=sbms" class="panel-title wytitle" id="yframe-1"><icon style="color:#8d8d8d;" class="fa fa-cart-plus"></icon>房型管理</a>',
        ...
        $cur_color = '#8d8d8d';
        $navemenu[2] = array(
           'title' => '<a href="zhjd.php?c=site&a=entry&op=display&do=dlinorder&m=sbms" class="panel-title wytitle" id="yframe-2"><icon style="color:#8d8d8d;" class="fa fa-cog"></icon> 订单管理</a>',
            'items' => array(
        ...
        $cur_color = '#8d8d8d';
            ...
            $navemenu[3] = array(
               'title' => '<a href="zhjd.php?c=site&a=entry&op=display&do=dlnumber&m=sbms" class="panel-title wytitle" id="yframe-3"><icon style="color:#8d8d8d;" class="fa fa-compass"></icon>酒店维护</a>',
                'items' => array(
        ...
        $cur_color = '#8d8d8d';
        $navemenu[4] = array(
           'title' => '<a href="zhjd.php?c=site&a=entry&op=display&do=dlincoupon&m=sbms" class="panel-title wytitle" id="yframe-4"><icon style="color:#8d8d8d;" class="fa fa-bars"></icon>优惠券管理</a>',
            'items' => array(
        ...
        $cur_color = '#8d8d8d';
        $navemenu[5] = array(
            'title' => '<a href="zhjd.php?c=site&a=entry&op=display&do=dlassess&m=sbms" class="panel-title wytitle" id="yframe-5"><icon style="color:#8d8d8d;" class="fa fa-user"></icon> 评论管理</a>',
            'items' => array(
                0 => $this->createSubMenu('评论管理 ', $do, 'dlassess', 'fa-angle-right', $cur_color, $storeid),
            )
        );
         $navemenu[7] = array(
                'title' => '<a href="zhjd.php?c=site&a=entry&op=display&do=dltxdetails&m=sbms" class="panel-title wytitle" id="yframe-7"><icon style="color:#8d8d8d;" class="fa fa-bars"></icon>提现管理</a>',
                'items' => array(
        ...
        $cur_color = '#8d8d8d';
        $navemenu[6] = array(
              'title' => '<a href="zhjd.php?c=site&a=entry&op=display&do=dlprint&m=sbms" class="panel-title wytitle" id="yframe-6"><icon style="color:#8d8d8d;" class="fa fa-cog"></icon>  消息设置</a>',
            'items' => array(
            ...
            'title' => '<a href="zhjd.php?c=site&a=entry&op=display&do=dlaccount&m=sbms" class="panel-title wytitle" id="yframe-14"><icon style="color:#8d8d8d;" class="fa fa-newspaper-o"></icon>  账号管理</a>',
            'items' => array(
        ...
        //       // echo $nav;die;
        //     $navemenu[0] = array(
        //      'title' => '<a href="zhjd.php?c=site&a=entry&op=display&do='.$nav.'&m=sbms" class="panel-title wytitle" id="yframe-0"><icon style="color:#8d8d8d;" class="fa fa-newspaper-o"></icon>  门店信息</a>',
        //     'items' => $arr1,
        //     'icon' => 'fa fa-user-md',
        //      );
        // }
        ...
        //         }  
        //     $navemenu[1] = array(
        //      'title' => '<a href="zhjd.php?c=site&a=entry&op=display&do='.$nav.'&m=sbms" class="panel-title wytitle" id="yframe-0"><icon style="color:#8d8d8d;" class="fa fa-newspaper-o"></icon>  房型管理</a>',
        //     'items' => $arr2,
        //     'icon' => 'fa fa-user-md',
        //      );
        // }
...
/*    function createSubMenu($title, $do, $method, $icon = "fa-image", $color = '#d9534f', $storeid)
    ...
    {
        $store = pdo_fetch("SELECT * FROM " . tablename('sbms_seller') . " WHERE id=:id LIMIT 1", array(':id' => $id));
        return $store;
    }
...
function set_msg($_W,$order_id){
    ...
    $res=pdo_get('sbms_system',array('uniacid'=>$_W['uniacid']));
    $sql="select a.*,b.tel as seller_tel from " . tablename("sbms_order")."a left join".tablename('sbms_seller')."b on a.seller_id=b.id WHERE a.id=:order_id  ";
    $list=pdo_fetch($sql,array(':order_id'=>$order_id));
    $userInfo=pdo_get('sbms_user',array('id'=>$list['user_id']),'openid');
...
echo set_msg($_W,$order_id);
    ...
    public function _exce($do, $default = ''){
        global $_GPC;
        $do = strtolower(substr($do,8));
        $p  = trim($_GPC['p']);
        empty($p) && $p = $default;
        $file = IA_ROOT . "/addons/sbms/mobile/" . $do . "/" . $p . ".php";
        if (!is_file($file)) {
